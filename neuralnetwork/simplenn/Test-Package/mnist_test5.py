...
# ---------------- This Test trains a pertained 196-150-10 Network and tries to push up the accuracy by training the pictures all again randomly. --------------
...
#         plt.show()
        ...
        params = self.read_params('weigths_after_test_3_2018-07-08_020132.txt')
        ...
        mnist_net_single.save_params('weights_after_test_5')
    ...
    def write_time(self, start, end, start_time):
        title = 'times_for_mnist_net_5_' + self.time_stamp + '.txt'
    ...
    def write_acc(self, list):
        title = 'accuracy_for_mnist_net_5_' + self.time_stamp + '.txt'
        with open(title, 'a') as f:
            f.write(str(list) + '\n')
