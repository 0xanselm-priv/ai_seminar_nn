...
# -------------------------------- This test trains a 196-100-10 Net with every Training Image once in order! --------------
...
#         plt.show()
    ...
    def write_time(self, start, end, start_time):
        title = 'times_for_mnist_net_1_' + self.time_stamp + '.txt'
    ...
    def write_acc(self, list):
        title = 'accuracy_for_mnist_net_1_' + self.time_stamp + '.txt'
        with open(title, 'a') as f:
            f.write(str(list) + '\n')
