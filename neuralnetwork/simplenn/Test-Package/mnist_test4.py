...
# ---------------------------- This test trains a 196-150-10 Net with 55k Training Image randomly chosen with relu!--------------
...
#         plt.show()
        ...
        mnist_net_single = network_class.Network([(196), (150), (10)],  weights=None, bias=None, activation_function="relu", initilizer="xavier_relu", dropout=0.0)
        ...
        mnist_net_single.save_params('weights_after_test_3')
    ...
    def write_time(self, start, end, start_time):
        title = 'times_for_mnist_net_3_' + self.time_stamp + '.txt'
    ...
    def write_acc(self, list):
        title = 'accuracy_for_mnist_net_3_' + self.time_stamp + '.txt'
        with open(title, 'a') as f:
            f.write(str(list) + '\n')
