...
# -------------------------------- This test trains a 196-150-10 Net with 55k Training Image randomly! --------------
...
#         plt.show()
        ...
        mnist_net_single = network_class.Network([(196), (150), (10)],  weights=None, bias=None, activation_function="sigmoid", initilizer="xavier_sigmoid", dropout=0.0)
