...
# -------------------------------- This test trains a 196-100-10 Net with 55k Training Image randomly! --------------
...
#         plt.show()
    ...
    def write_time(self, start, end, start_time):
        title = 'times_for_mnist_net_2_' + self.time_stamp + '.txt'
    ...
    def write_acc(self, list):
        title = 'accuracy_for_mnist_net_2' + self.time_stamp + '.txt'
        with open(title, 'a') as f:
            f.write(str(list) + '\n')
